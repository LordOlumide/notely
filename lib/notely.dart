...
import 'package:notely/app/user_interface/screens/get_started_screen.dart';
import 'package:notely/app/user_interface/screens/notes_screen.dart';
...
class Notely extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [ListenableProvider(create: (_) => NotesProvider())],
      child: MultiBlocProvider(
        ...
        child: MaterialApp(
          ...
          home: BlocBuilder<AuthCubit, AuthState>(builder: (_, state) {
            log('state: $state');
